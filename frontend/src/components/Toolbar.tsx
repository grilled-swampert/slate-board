  ...
  return (
    <div className="w-16 lg:w-72 bg-white border-r border-gray-200 p-4 flex flex-col space-y-4">
      <div className="space-y-2">
        <h3
          className="hidden lg:block text-sm font-medium text-gray-700 font-maven"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
          {tools.map(({ type, icon: Icon, label }) => (
            ...
            >
              ...
              <span
                className="hidden lg:inline text-sm font-trirong"
      ...
      <div className="space-y-2 pt-4 border-t border-gray-200">
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <span
              className="hidden lg:inline text-sm font-poppins"
